    ...
    <div className="bg-black">
      ...
      <main>
        <section id="inicioPage" className="bg-white w-full h-[2300px]">
          ...
          <section id='card inicio black' className="flex  rounded-t-[40px]  rounded-b-[40px]   mt-2 bg-gray-950 w-full h-[380px]">
        ...
        <section id="Sessão banner devRemote" className="flex-col  bg-gray-50 w-full h-[550px] ">
          <h1 className=' text-gray-800 font-bold text-9xl '>DevRemote.</h1>
          <h1 className=' text-gray-800 font-bold text-9xl'>DevRemote.</h1>
          <h1 className=' text-gray-800 font-bold text-9xl'>DevRemote.</h1>
           </section>
